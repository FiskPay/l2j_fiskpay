...
%mysqlPath% -h %LSHOST% -u %LSUSER% --password=%LSPASS% -D %LSDB% < ../sql/fiskpay_deposits.sql
%mysqlPath% -h %LSHOST% -u %LSUSER% --password=%LSPASS% -D %LSDB% < ../sql/fiskpay_temporary.sql
%mysqlPath% -h %LSHOST% -u %LSUSER% --password=%LSPASS% -D %LSDB% < ../sql/fiskpay_withdrawals.sql
